...
def load_data():
    ...
    with (open(file_path,'r')) as data_from:
        ...
        for i in csv_reader:
            ...
            label_list=[0]*23
            feature.append(i[:36])
            label_list[int(float(i[41]))]=1
            label.append(label_list)
            # print label
            # print feature
    #file_path_full = '/dev/new.cvs'
    file_path_full ='kddcup.data.corrected_handled2.cvs'
    with (open(file_path_full,'r')) as data_from_full:
        ...
        for j in csv_reader_full:
            ...
            label_list_full[int(float(j[41]))]=1
